...
function greatingsPt(string1, string2, string3 = '!') {
    const result = `${string1} ${string2} ${string3}`
    console.log(result)
    return result
}
greatingsPt('Bom', 'dia')
greatingsPt('Bom', 'dia', 'gente')

const greatingsPtArrow = (string1, string2, string3 = '!') => {
    const result = `${string1} ${string2} ${string3}`
    console.log(result)
    return result
}

greatingsPtArrow('Bom', 'dia')
greatingsPtArrow('Bom', 'dia', 'gente')
